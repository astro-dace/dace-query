...
- :ref:`A DACE account <create-account>`
- :ref:`An API key <api-key>`
- :ref:`A local .dacerc file <dacerc>`
...
Create an account
=================
Register on the `DACE web portal <https://dace.unige.ch/createAccount/>`_ with the university email address.
...
To obtain an API key:
    ...
    3.  Click on [Generate a new API key]
        ...
        .. image:: _static/generate-api-key.png
